 ...
 * @author Gabriela
 */
public class jExcluiMotivo extends javax.swing.JFrame {

    /**
     * Creates new form jExcluiMotivo
     */
    public jExcluiMotivo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("  Exclui Motivo   ");
        ...
        setSize(new java.awt.Dimension(806, 621));
    ...
    private void jButtonCadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Selecione um motivo para excluir!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jExcluiMotivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
